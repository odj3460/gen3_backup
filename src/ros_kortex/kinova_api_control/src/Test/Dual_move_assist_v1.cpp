...
public:
    AdmittanceController() : mass_(0.04), damping_(0.25), stiff_(0.00001), velocity_(3, 0.0f), position_(3, 0.0f)
    {
        // velocity_[0] = 0.0;
        // velocity_[1] = 0.0;
        // velocity_[2] = 0.0;
...
int main(int argc, char **argv)
{
    ...
    std::vector<float> pose_Leader_way00 = {0.344f, 0.002f, 0.33f, 180.0f, 0.0f, 90.0f};
    std::vector<float> pose_Leader_way0 = {0.344f, 0.002f, 0.230f, 180.0f, 0.0f, 90.0f};
    std::vector<float> pose_Leader_way1 = {0.344f, -0.3f, 0.230f, 180.0f, 0.0f, 90.0f};

    std::vector<float> pose_Leader_way2 = {0.344f, -0.3f, 0.230f, 180.0f, 0.0f, 90.0f};
    std::vector<float> pose_Leader_way3 = {0.344f, -0.3f, 0.230f, 180.0f, 0.0f, 90.0f};
    std::vector<float> pose_Leader_way4 = {0.344f, -0.3f, 0.230f, 180.0f, 0.0f, 90.0f};
    std::vector<float> pose_Leader_way5 = {0.344f, 0.0f, 0.230f, 180.0f, 0.0f, 90.0f};
