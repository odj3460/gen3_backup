...
int main(int argc, char **argv)
{
    ...
    LowPassFilter lpf(2.0, 0.02);  /// low-pass filter
    float filter_wrench = 0;
    ...
    {   
        ...
        filter_wrench = lpf.update(diff_wrench_R[2]);


        std::cout << "Not filter :  " <<  diff_wrench_R[2]  <<  std::endl;
        std::cout << "filter :  " <<  filter_wrench  <<  std::endl;
        ...
        //run_twist_command(base_cyclic_R, base_R, new_pose_R, loop_ms);
