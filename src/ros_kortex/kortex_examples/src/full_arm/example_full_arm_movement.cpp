...
bool example_send_cartesian_pose(ros::NodeHandle n, const std::string &robot_name)
{
  ...
  service_execute_waypoints_trajectory.request.input.waypoints.push_back(FillCartesianWaypoint(current_x, current_y + 0.10,  current_z + 0.10, current_theta_x, current_theta_y, current_theta_z, 0));
