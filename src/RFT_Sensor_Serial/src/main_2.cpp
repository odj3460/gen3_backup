...
/*
	Global Variables
*/
std::string g_com_port_2 		= "/dev/ttyUSB1";	// default serial device name...
int 		g_baud_rate 		= 115200; //921600;//115200;			// default baud-rate serial device...
...
/*
	Funcitions
*/
void init_param_2(ros::NodeHandle *nk);
...
uint8_t rft_response_display(uint8_t opType)
{
	...
	case CMD_FT_CONT_STOP:
		...
		ROS_INFO("RFT Force Toque topic is stopped...");
		break;
	case CMD_RESERVED_1:
		result = NOT_SUPPORTED_CMD;
		break;
